...
function calc() {
        ...
        function calcTotal() {
            if (!gender || !height || !weight || !age || !ratio) {
                result.textContent = '____';  //введите данные
                return;
            }
            if (gender === 'female') {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({container, slide, nextArrow, prevAroow, totalCounter, currentCounter, wrapper, field }) {
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2024-02-27');
